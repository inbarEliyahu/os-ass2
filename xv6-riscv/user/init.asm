...
main(void)
{
  ...
  6e:	8b650513          	addi	a0,a0,-1866 # 920 <malloc+0x152>
  ...
  b2:	82a50513          	addi	a0,a0,-2006 # 8d8 <malloc+0x10a>
  b6:	00000097          	auipc	ra,0x0
  ba:	65a080e7          	jalr	1626(ra) # 710 <printf>
      printf("init: fork failed\n");
  be:	00001517          	auipc	a0,0x1
  c2:	82a50513          	addi	a0,a0,-2006 # 8e8 <malloc+0x11a>
  c6:	00000097          	auipc	ra,0x0
  ca:	64a080e7          	jalr	1610(ra) # 710 <printf>
      exit(1);
  ce:	4505                	li	a0,1
  ...
  dc:	88858593          	addi	a1,a1,-1912 # 960 <argv>
  e0:	00001517          	auipc	a0,0x1
  e4:	82050513          	addi	a0,a0,-2016 # 900 <malloc+0x132>
  e8:	00000097          	auipc	ra,0x0
  ec:	2d0080e7          	jalr	720(ra) # 3b8 <exec>
      printf("init: exec sh failed\n");
  f0:	00001517          	auipc	a0,0x1
  f4:	81850513          	addi	a0,a0,-2024 # 908 <malloc+0x13a>
...
0000000000000430 <cpu_process_count>:
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 480:	4cc50513          	addi	a0,a0,1228 # 948 <digits>
 484:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 68c:	2b890913          	addi	s2,s2,696 # 940 <malloc+0x172>
        while(*s != 0){
...
free(void *ap)
{
 ...
 754:	2207b783          	ld	a5,544(a5) # 970 <freep>
 ...
 782:	00e6ea63          	bltu	a3,a4,796 <free+0x50>
{
 ...
 7c4:	1af73823          	sd	a5,432(a4) # 970 <freep>
}
 7c8:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7f6:	17e53503          	ld	a0,382(a0) # 970 <freep>
 ...
 81e:	15690913          	addi	s2,s2,342 # 970 <freep>
  if(p == (char*)-1)
 822:	5afd                	li	s5,-1
 824:	a88d                	j	896 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 826:	00000797          	auipc	a5,0x0
 82a:	15278793          	addi	a5,a5,338 # 978 <base>
 82e:	00000717          	auipc	a4,0x0
 832:	14f73123          	sd	a5,322(a4) # 970 <freep>
 836:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 858:	10a73e23          	sd	a0,284(a4) # 970 <freep>
      return (void*)(p + 1);
